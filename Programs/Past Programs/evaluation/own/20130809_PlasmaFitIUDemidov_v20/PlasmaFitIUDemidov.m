function iudata = PlasmaFitIUDemidov(data, p_chk, p_fix, p_Vint, ...
  p_Vavg, p_IsRg, p_fitgoal, p_scanstepsize, ask4manfit)
%==========================================================================
% function iudata = PlasmaFitIUDemidov(data, p_chk, p_fix, p_Vint, ...
%   p_Vavg, p_IsRg, p_fitgoal, p_stepsize, ask4manfit)
%
...
%     ask4manfit: 1: manual fit after auto fit, 0: just auto fit
...
if L5==0
  disp('I-V characteristic is too short -> no evaluation')
  iudata = [];
  return
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   if ask4manfit==1
      ...
      answer = input('Would you like to perform a manual fit (1:yes)?');
      if answer==1
        PlasmaFitIUDemidov_manual_v01(fitpar,q)
      else
