function iudata = PlasmaFitIULangmuirNew_v01(data, p_chk, p_fix, p_Vint, ...
  p_Vavg, p_IsRg, p_scanstepsize, p_fitmethod)
%==========================================================================
% function iudata = PlasmaFitIUDemidov_v11(data, p_chk, p_fix, p_Vint, ...
%   p_Vavg, p_IsRg, p_fitgoal, p_scanstepsize, p_fitmethod)
%
% Last Change: 2013-02-15 12:16 C. Brandt, San Diego
