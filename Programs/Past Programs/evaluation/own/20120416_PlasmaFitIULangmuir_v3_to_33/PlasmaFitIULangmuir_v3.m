function [iudata, raw] = PlasmaFitIULangmuir_v3(data, checkonoff, ...
  fixpar, Vint, vol_avg, DIeexp_level)
%==========================================================================
%function [iudata] = PlasmaFitIULangmuir_v3(data, checkonoff, fixpar, ...
% Vint, vol_avg)
% Last Change: 2012-04-13 10:23 C. Brandt, San Diego
