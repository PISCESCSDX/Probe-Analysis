function [iudata, raw] = PlasmaFitIULangmuir_v31(data, checkonoff, ...
  fixpar, Vint, vol_avg, DIeexp_level)
%==========================================================================
%function [iudata] = PlasmaFitIULangmuir_v31(data, checkonoff, fixpar, ...
% Vint, vol_avg)
% Last Change: 2012-04-14 12:19 C. Brandt, San Diego
% - Test version: Insert variable length of fitting
%--------------------------------------------------------------------------
...
puttextonplot(gca, [0 0], 10,110, ...
  ['NID=' sprintf('%4.2f', iudata.NID)], 0, 12, 'k');
